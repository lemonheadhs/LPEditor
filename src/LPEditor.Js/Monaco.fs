...
let [<Import("*","monaco-editor/esm/vs/editor/editor.api")>] monaco: Monaco.IExports = jsNative

module Monaco =
    let [<Import("editor","monaco-editor/esm/vs/editor/editor.api")>] editor: Editor.IExports = jsNative
    let [<Import("languages","monaco-editor/esm/vs/editor/editor.api")>] languages: Languages.IExports = jsNative
    ...
    type [<AllowNullLiteral>] KeyModStatic =
        ...
        abstract chord: firstPart: int * secondPart: int -> int
    ...
    module Editor =
        ...
        type [<AllowNullLiteral>] IActionDescriptor =
            ...
            abstract keybindings: ResizeArray<int> option with get, set
    ...
    module Languages =
        importSideEffects "monaco-editor/esm/vs/language/typescript/monaco.contribution.js"
        importSideEffects "monaco-editor/esm/vs/language/css/monaco.contribution.js"
        importSideEffects "monaco-editor/esm/vs/language/json/monaco.contribution.js"
        importSideEffects "monaco-editor/esm/vs/language/html/monaco.contribution.js"
        let typescript: Typescript.IExports = Monaco.languages?typescript
        let css: Css.IExports = Monaco.languages?css
        let json: Json.IExports = Monaco.languages?json
        let html: Html.IExports = Monaco.languages?html
